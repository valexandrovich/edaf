...
export default {
  ...
  mounted(){
    ...
    const enableBodyScroll = bodyScrollLock.enableBodyScroll;
           //Hide popup sections
        document.querySelectorAll(this.selectors.popup)
            .forEach(elem => elem.querySelector(this.selectors.closeBtn).addEventListener('click', function(e) {
        ...
        // //Open popup sections
        document.querySelectorAll(this.selectors.popupControl)
