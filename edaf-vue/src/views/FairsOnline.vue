  ...
  <div style="height:100%">
    ...
    <section class="collection-content" data-tabs>
     ...
     <iframe
        ...
        <div class="collection-content__container container" role="tabpanel" id="tab-content-2" tabindex="0" aria-labelledby="tab-2" hidden>
   
      <iframe
          :src="`https://v-art-82948.web.app/galleries/edaf_space_station/`"
          width="100%"
          height="650"
          allowfullscreen
          frameborder="0"
        ...
        <div class="collection-content__products grid">
          <div
            @click="goSpaces(product.id)"
            data-aos="fade-up"
            class="product-card grid-cell"
            v-for="product in productsSpaces"
            :key="product.id"
          >
            <h2 class="product-card__heading h5">
              <a> {{ product.attributes.product.name }} </a>
