          ...
          <div class="product-hero__gallery product__swiper">
            <div class="swiper-wrapper">
              <div class="product-hero__slide swiper-slide">
                <img src="images/product/pdp-image_1.jpeg" alt="Data Fossils" class="product-hero__image">
              </div>
              <div class="product-hero__slide swiper-slide">
                <img src="images/product/pdp-image_1.jpeg" alt="Data Fossils" class="product-hero__image">
              </div>
          ...
          <div class="product-hero__info">
            ...
            <form action="cart/add" method="POST" class="product-hero__form">
              <select name="id" id="product-select" class="no-js">
                <option value="product_id_here" data-price="product_price_here" data-id="product_id_here">PRODUCT_NAME_HERE</option>
              </select>
    ...
    <script type="application/ld+json">
      {
        ...
        "@type": "Product",
        "name": "Data Fossils",
        "image": "/images/product/pdp-image_1.jpeg",
      ...
      <div class="artist-info__inner">
        <div class="artist-info__media">
          <div class="artist-info__image">
            <img src="images/product/author-img.jpeg" alt="Artist">
          </div>
